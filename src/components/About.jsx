                    ...
                    <div className=' w-full lg:w-6/12 max-xl:px-[12px] flex justify-center lg:justify-end mt-[30px] md:mt-12'>
                        <div className=' flex flex-col'>
                            <div className=' relative inline-block max-lg:flex max-lg:justify-center'>
                                ...
                                <img className='max-sm:max-w-[270px] max-md:max-w-[280px] max-lg:w-[350px] absolute top-[50%] lg:left-0' src={top_Red} alt="redline" />
                                <img className='max-sm:max-w-[270px] max-md:max-w-[280px] max-lg:w-[350px] absolute bottom-[-6px] lg:left-1' src={bottom_Red} alt="redline" />
                            </div>
