...
const Featured = () => {
    ...
    return (
        <div className=' bg-featured_bg bg-no-repeat bg-cover 2xl:bg-100% flex flex-col pb-[80px] sm:pb-[128px] md:pb-[168px] lg:pb-[175px] -mt-[2px]'>
            ...
            <div className=' max-w-[1440px] mx-auto featured_Slider pt-[30px] sm:pt-[55px] md:pt-[70px] lg:pt-[89px] relative z-20'>
                <Slider {...settings2}>
                    <div className=' bg-featured_sliderbg backdrop-blur-lg max-w-[364px] w-full p-5 flex flex-col md:min-h-[461px] bg-100%  bg-no-repeat'>
                        ...
                        <p className=' font-poppins font-normal text-base leading-[22px] md:text-[18px] md:leading-[28px] opacity-70 text-white pt-2 sm:pt-3'>Embark on thrilling adventures in a volcanic world, featuring unique challenges and excitement, crafted exclusively for Roblox players.</p>
                    </div>
                    <div className=' bg-featured_sliderbg backdrop-blur-lg max-w-[364px] w-full p-5 flex flex-col md:min-h-[461px] bg-100%  bg-no-repeat'>
