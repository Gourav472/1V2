...
import { HeadingVector2 } from '../common/Icon'
        ...
        <div id='Portfolio' className='relative bg-impact_bg bg-cover 2xl:bg-100% bg-no-repeat pb-[48px] sm:pb-[68px] md:pb-[90px] lg:pb-[121px] -mt-[2px]'>
            ...
            <div className='container max-w-[1164px] relative z-20'>
                <div className='flex flex-wrap flex-row mx-3 pt-[15px] sm:pt-[60px] md:pt-[80px] lg:pt-[102px]'>
                    ...
                    <div className='w-full 2xl:p-0 md:w-7/12 lg:w-6/12 px-3 flex justify-center lg:justify-center max-md:mt-[25px] max-lg:mt-[48px]'>
                        <img className='pointer-events-none max-w-[360px] sm:max-w-[390px] lg:w-[445px] lg:h-[433px] w-full' src={impact_Horse} alt="horse" />
                    </div>
