        ...
        <div id='Contact' className='relative -my-[2px] bg-footer_bg bg-no-repeat bg-cover 2xl:bg-100%'>
            <div className='container max-w-[1164px] relative z-20'>
                <div className='flex flex-col items-center'>
                    <a href="/"><img src={navLogo} alt="footer-logo" /></a>
                    ...
                    <div className='flex items-center gap-5 pt-4'>
                        <a href="https://x.com/?lang=en" rel='noreferrer' target='_blank' className='w-[43px] h-[43px] rounded-full hover:translate-y-2 custom_duration bg-red border-[2.46px] border-sky_blue flex items-center justify-center'>
                            <Twitter />
                        </a>
                        <a href="https://discord.com/" rel='noreferrer' target='_blank' className='w-[43px] h-[43px] rounded-full bg-red border-[2.46px] hover:translate-y-2 custom_duration border-sky_blue flex items-center justify-center'>
                            <Discord />
                        </a>
                    </div>
                </div>
