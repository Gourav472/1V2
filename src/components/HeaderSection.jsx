      ...
      <div className=' bg-header_bg relative bg-no-repeat bg-cover'>
        <div className=' container max-w-[1164px] relative z-20 '>
          <div className=" flex justify-between items-center pt-[6px] pb-2">
            ...
            <ul
              className={` flex flex-col lg:flex-row items-center gap-[32px] max-lg:fixed max-lg:justify-center top-0 max-lg:-left-full max-lg:z-[90] max-lg:h-screen max-lg:w-full  ${show ? "" : " !start-0"
                }`}
            >
          ...
          <div className=' flex justify-center lg:justify-start pt-[100px] sm:pt-[130px] md:pt-[144px] pb-[100px] sm:pb-[130px] md:pb-[170px] lg:pb-[208px]'>
            <div className=' flex flex-col relative z-20'>
              ...
              <p className='max-w-[500px] md:max-w-[600px] lg:max-w-[465px] opacity-70 font-poppins font-normal text-[14px]  sm:text-base md:text-xl leading-[22px] md:leading-8 text-white pt-3 sm:pt-4 text-center lg:text-start'>Leading the Way in Creating Unique and Innovative Experiences on Roblox.</p>
              <div className=' max-lg:mx-auto mt-7 sm:mt-8 md:mt-[42px]'>
                <Common_Btn buttonName="Contact Us" />
              </div>
            </div>
            <img className='max-xl:pointer-events-none z-10 max-w-[602px] opacity-50 lg:opacity-70 xl:opacity-100 lg:right-0 top-[126px] absolute w-full' src={Hero} alt="hero-image" />
